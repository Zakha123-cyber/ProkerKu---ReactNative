        ...
        <View className="p-4 border-2 border-green-500 rounded-lg">
          ...
          <View className="p-2 mb-2 border-2 border-gray-300 rounded-lg">
            {isEditing ? (
              <TextInput
                ...
                onChangeText={(text) =>
                  setProker({ ...proker, timeline: text })
                }
          ...
          <View className="p-2 mb-2 border-2 border-gray-300 rounded-lg">
            {isEditing ? (
              <TextInput
                ...
                onChangeText={(text) =>
                  setProker({ ...proker, deskripsi: text })
                }
                className="text-gray-600"
              />
            ) : (
          ...
          <View className="flex-row justify-between pb-3 mt-4 border-b-2 border-gray-300 b-3">
            {isEditing ? (
              <>
                <Pressable
                  className="flex-1 p-2 mr-2 bg-green-500 rounded-lg"
                  onPress={handleSave}
                >
                  <Text className="text-center text-white">Simpan</Text>
                </Pressable>
                <Pressable
                  className="flex-1 p-2 ml-2 bg-gray-500 rounded-lg"
